...
const FORK_DEFAULTS = {
  ...
  labels: {
    ...
    guestCrmSalutation: "Anrede",
    guestCrmStreet: "Strasse / Nr.",
    guestCrmPostalCode: "PLZ",
    guestCrmCity: "Ort",
    guestCrmCountry: "Land",
    guestCrmDateOfBirth: "Geburtsdatum",
    guestCrmGender: "Geschlecht",
    guestCrmNationality: "Nationalität",
    guestCrmHeightCm: "Grösse (cm)",
    guestCrmWeightKg: "Gewicht (kg)",
    guestCrmShoeSizeEu: "Schuhgrösse (EU)",
    guestCrmEmergencyName: "Notfallkontakt Name",
    guestCrmEmergencyPhone: "Notfallkontakt Telefon",
    ...
    commsPageTitle: "Kommunikation & Newsletter",
    commsPageLead:
      "Terminerinnerungen feinjustieren und Marketing-Mails an Gäste mit Newsletter-Opt-in senden.",
    commsTabReminders: "Terminerinnerungen",
    commsTabNewsletter: "Newsletter",
    commsRemindersEnabled: "Erinnerungen aktiv",
    commsHoursBeforeLabel: "Stunden vor dem Termin",
    commsHoursBeforeHint:
      "Mail/SMS wird in einem kurzen Fenster um diese Vorlaufzeit herum verschickt (Polling).",
    commsWindowHoursLabel: "Fenster (Stunden)",
    commsWindowHoursHint: "Breite des Zeitfensters für den Versand — nicht kleiner als der Poll-Abstand.",
    commsPollIntervalLabel: "Abfrage alle (Millisekunden)",
    commsPollIntervalHint: "Mindestens 10 000. Server prüft jede Minute, ob ein Lauf fällig ist.",
    commsMediumLabel: "Kanal",
    commsMediumEmail: "Nur E-Mail",
    commsMediumSms: "Nur SMS (Webhook)",
    commsMediumBoth: "E-Mail und SMS",
    commsSmsWebhookLabel: "SMS-Webhook-URL",
    commsSmsWebhookHint:
      "POST JSON { to, text }. Leer = Umgebungsvariable REMINDER_SMS_WEBHOOK_URL.",
    commsResetEnvDefaults: "Auf Umgebungs-Defaults zurücksetzen",
    commsSave: "Einstellungen speichern",
    commsSavedToast: "Kommunikationseinstellungen gespeichert.",
    commsEnvFallbackNote:
      "Ohne Einträge in der Datenbank gelten die Werte aus .env / Docker (REMINDER_*).",
    newsletterSingular: "Newsletter",
    newsletterSubjectLabel: "Betreff",
    newsletterHtmlLabel: "Inhalt (HTML)",
    newsletterHtmlHint:
      "Du kannst Überschriften, Absätze und Links mit HTML formatieren. Vorschau rechts.",
    newsletterRecipientBadge: "Empfänger mit Opt-in & E-Mail",
    newsletterPreviewTitle: "Vorschau",
    newsletterCreateDraft: "Entwurf anlegen",
    newsletterSendNow: "Jetzt senden",
    newsletterSendConfirm:
      "Wirklich an alle Empfänger mit Marketing-Opt-in und gültiger E-Mail senden?",
    newsletterSending: "Senden …",
    newsletterSentToast: "Newsletter wurde versendet.",
    newsletterHistoryTitle: "Letzte Kampagnen",
    newsletterStatusDraft: "Entwurf",
    newsletterStatusSent: "Gesendet",
    newsletterRecipientsTemplate: "{count} Empfänger",
    newsletterSentCountTemplate: "{sent} von {total} zugestellt",
    newsletterCreateFailed: "Newsletter-Entwurf konnte nicht angelegt werden.",
    newsletterAlreadySent: "Dieser Newsletter wurde bereits gesendet.",
    newsletterSendFailed: "Newsletter-Versand ist fehlgeschlagen.",
    newsletterEmptySubject: "Bitte einen Betreff eingeben.",
    newsletterEmptyBody: "Bitte HTML-Inhalt eingeben.",
    newsletterFooterOptInNote:
      "Du erhältst diese Nachricht, weil du bei {siteName} Hinweise & Angebote per E-Mail aktiviert hast.",
    newsletterPreheaderDefault: "Neuigkeiten von {siteName}",
    newsletterHeroLead: "Neuigkeiten & Angebote für dich",
    newsletterGreetingHello: "Hallo",
    guestCrmSectionContact: "Kontakt & Quelle",
    guestCrmSectionAddress: "Adresse",
    guestCrmSectionPerson: "Person",
    guestCrmSectionEquipment: "Körpermasse & Ausrüstung",
    guestCrmSectionEmergency: "Notfall",
    guestCrmSectionOther: "Sonstiges",
    guestGenderWeiblich: "weiblich",
    guestGenderMaennlich: "männlich",
    guestGenderDivers: "divers",
    guestGenderUnbekannt: "keine Angabe",
    guestContactChannelEmail: "E-Mail",
    guestContactChannelPhone: "Telefon",
    guestContactChannelSms: "SMS",
    guestContactChannelWhatsapp: "WhatsApp",
    guestListCityAbbrev: "Ort",
    guestCrmSalutationPlaceholder: "z. B. Herr, Frau",
